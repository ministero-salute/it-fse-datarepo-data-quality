 ...
 */
package it.finanze.sanita.fse2.dr.dataquality.logging;
...
import it.finanze.sanita.fse2.dr.dataquality.dto.LogDTO;
import it.finanze.sanita.fse2.dr.dataquality.enums.ResultLogEnum;
import it.finanze.sanita.fse2.dr.dataquality.service.ILogEnum;
...
public class LoggerHelper {
	 ...
	 */
	public void trace(String message, ILogEnum operation, ResultLogEnum result, Date startDateOperation, String issuer, String documentType, String subjectRole, String subjectFiscalCode) {
	...
	public void debug(String message, ILogEnum operation, ResultLogEnum result, Date startDateOperation, String issuer, String documentType, String subjectRole, String subjectFiscalCode) {
	...
	public void info(String message, ILogEnum operation, ResultLogEnum result, Date startDateOperation, String issuer, String documentType, String subjectRole, String subjectFiscalCode) {
